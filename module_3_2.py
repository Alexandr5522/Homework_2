def send_email(message, recipient, sender="university.help@gmail.com"):
    correct_sender = ('.com', '.ru', '.net')  # кортеж суффиксов
    # проверяем равные переменные на наличие суффиксов, start = не обязателен end = -4
    valid = recipient.endswith(correct_sender, -4) == sender.endswith(correct_sender, -4)
    # проверяем наличие элемента "@" в перемнной recipient и sender
